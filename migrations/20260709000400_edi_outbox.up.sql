CREATE TABLE IF NOT EXISTS edi.outbox_events (
...
CREATE INDEX IF NOT EXISTS idx_edi_outbox_unpublished ON edi.outbox_events (occurred_at) WHERE published_at IS NULL;
CREATE TABLE IF NOT EXISTS edi.inbox_consumed (
  consumer text NOT NULL, event_id uuid NOT NULL, consumed_at timestamptz NOT NULL DEFAULT now(),
