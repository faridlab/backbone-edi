//! Domain policy for EdiDocument aggregate
//!
...
/// Domain policy for EdiDocument — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EdiDocument>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EdiDocumentDomainPolicy = PermitAllPolicy<EdiDocument>;
