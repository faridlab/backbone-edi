//! Specifications for EdiDocument aggregate
//!
...
// Each predicate implements `Specification<EdiDocument>` and can be combined
...
//
// pub struct ActiveEdiDocumentSpec;
// impl Specification<EdiDocument> for ActiveEdiDocumentSpec {
//     fn is_satisfied_by(&self, e: &EdiDocument) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
