...
/// Create stateless routes for the Edi module.
///
...
///
/// ```ignore
/// let module = EdiModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::EdiModule) -> Router<()> {
    Router::new()
...
pub fn get_routes(module: &crate::EdiModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Edi module.
///
...
pub fn create_combined_routes(module: &crate::EdiModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Edi module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::EdiModule) -> Router<AppState> {
    Router::new()
